...
const quizData = [
  ...
  {//2
    question: "Он не летает, но переносит нас в другие страны, не читает вслух, но дарит живую речь. Что за таинственное устройство помогает изучать язык в кабинете английского языка?",
