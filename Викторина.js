...
const quizData = [
  ...
  {//2
    question: "Как ты думаешь, что вдохновляет стать учителем? Ответы учителей были похожими. Это и первый учитель, классный руководитель или учитель, который запомнился. Это и желание работать с детьми, в школьной атмосфере, быть полезнам обществу. Отгадай какого учителя вдохновила её бабушка — учитель математики?",
    answers: ["Яна Николаевна Погибельная", "Елена Константиновна Данченко", "Надежда Петровна Старовойтова"],
    correct: 2
  },
  {//3
    question: "Вдохновение может быть разным и придти в разное время. Кто-то мечтал стать учителем с раннего дества, кто-то определися в подростковом возрасте, а кого-то привела судьба в более поздние годы. Чья жизнь была связана с гимназией гораздо теснее, ведь этот человек ходил в нашу школу ещё будучи первоклашкой?",
  ...
  {
    question: "Какая книга или фильм оказало большое впечатление и повлияла на тебя? У наших учителей тоже есть свои предпочтения: «Повесть о настоящем человеке», «Два капитана», «Поллианна», произведения Яна Зенкера, А.Моруа, Д.Хармса, фильм «Офицеры» и многое другое. У кого из учителей такой книгой стали произведения Джоан роулинг о <<Гарри Поттере>>?",
